...
//        return;
    ...
    /**
     * Controls whether the Cancel button should be visible for a task for the
     * logged in user or not
     *
     * @param task the task object
     * @param loggedInUserId id of the logged in user
     * @return true if user is allowed to see the cancel button for a task else
     * false
     */
    ...
    /**
     * Controls whether the Sign Up button should be visible for a task for the
     * logged in user or not
     *
     * @param task the task object
     * @param loggedInUserId id of the logged in user
     * @return true if user is allowed to see the sign up button for a task else
     * false
     */
